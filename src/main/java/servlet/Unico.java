...
public class Unico{
    ...
    public void crearAsignacion ( int idProyecto, String idEmpleado,String responsabilidades){
        Asignacion asignacion = new Asignacion (idProyecto,idEmpleado,responsabilidades);
